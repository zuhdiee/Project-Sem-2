    ...
    <div class="max-w-2xl w-full flex bg-white rounded-[2rem] overflow-hidden login-container min-h-[380px]">
        ...
        <div class="w-full md:w-[58%] p-8 md:p-10 flex flex-col justify-center">
            ...
            <?php if(isset($_GET['logout']) && $_GET['logout'] == 'success'): ?>
                <div class="mb-6 logout-notification p-5 rounded-2xl flex items-start gap-4 border border-blue-200/50">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-blue-50 text-[11px] mt-1.5 leading-relaxed">
                            Anda telah berhasil keluar dari sistem. Terima kasih telah menggunakan <span class="font-semibold">Putra Surya Agung</span> Inventory System.
                        </p>
                    </div>
                </div>
            <?php endif; ?>
