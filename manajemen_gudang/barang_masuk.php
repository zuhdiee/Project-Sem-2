...
<head>
    ...
    <title>Barang Masuk | Putra Surya Agung</title>
...
<body class="flex h-screen overflow-hidden">
    ...
    <aside class="w-64 sidebar flex flex-col p-5 h-full shrink-0">
        ...
        <nav class="flex-1 overflow-y-auto pr-2">
            ...
            <a href="barang_masuk.php" class="nav-link nav-active">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <main class="flex-1 flex flex-col overflow-y-auto">
        <header class="h-16 flex items-center justify-between px-8 shrink-0 bg-white/80 backdrop-blur-md sticky top-0 z-10 border-b border-slate-200">
            <div class="flex items-center gap-2 bg-slate-100 px-3 py-1.5 rounded-lg w-80 border border-slate-200">
                ...
                <input type="text" placeholder="Cari data transaksi..." class="bg-transparent border-none outline-none text-[11px] w-full text-slate-600">
            </div>
        ...
        <div class="p-8">
            <div class="mb-8">
                <h1 class="text-[20px] font-bold text-slate-800 tracking-tight">Barang Masuk</h1>
                <p class="text-slate-500 text-[11px]">Input transaksi barang masuk gudang.</p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="number" class="input-field" placeholder="Rp 0">
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label>No. nota</label>
                            <input type="text" class="input-field" placeholder="Contoh: INV-001">
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="border-2 border-dashed border-slate-200 rounded-xl p-4 flex flex-col items-center justify-center bg-slate-50 h-[100px] text-center">
                            <svg class="w-6 h-6 text-slate-400 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" stroke-width="2"/></svg>
                            <p class="text-[9px] text-slate-400 font-medium">Upload foto bukti nota (opsional)</p>
                        </div>
                        <button class="w-full bg-emerald-500 hover:bg-emerald-600 text-white py-2.5 rounded-xl text-[11px] font-bold shadow-lg shadow-emerald-100 flex items-center justify-center gap-2 transition-all">
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="text-slate-400 text-[10px] uppercase tracking-wider border-b border-slate-100">
                                ...
                                <th class="pb-4 font-bold">Suplier</th>
                                <th class="pb-4 font-bold">Jumlah</th>
                                <th class="pb-4 font-bold">No. Nota</th>
                            </tr>
                        </thead>
                        <tbody class="text-[11px] text-slate-600">
                            <tr>
                                <td colspan="6" class="py-10 text-center text-slate-400 italic">Belum ada transaksi hari ini.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
